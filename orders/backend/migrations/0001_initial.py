# Generated by Django 2.2.13 on 2022-06-22 19:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('shop', 'Поставщик'), ('buyer', 'Менеджер закупок')], default='buyer', max_length=5, verbose_name='Тип пользователя')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='product_cards', to='backend.Product', verbose_name='Продукт')),
                ('shop', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='product_cards', to='backend.Shop', verbose_name='Магазин')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='product',
            name='shop',
            field=models.ManyToManyField(blank=True, related_name='products', to='backend.Shop', verbose_name='Магазины'),
        ),
        migrations.CreateModel(
            name='OrderItem',
            fields=[
                ...
                ('product_info', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='ordered_items', to='backend.ProductCard', verbose_name='Информация о продукте')),
            ],
            options={
